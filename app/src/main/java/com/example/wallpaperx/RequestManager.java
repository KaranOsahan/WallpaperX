...
public class RequestManager {
    ...
    public void searchCuratedWallpapers(SearchResponseListener listener, String page, String query){
        ...
        Call<SearchApiResponse> call = callWallpaperListSearch.searchWallpapers(query ,page , "250");
    ...
    private interface CallWallpaperList {
        @Headers({
                ...
                "Authorization: 4OBnjg3Ms3b52G4OQW9EeHGetuPbkactGEUux3LGhXrcQjqACp6LdC5y"
        })
        @GET("curated/")
